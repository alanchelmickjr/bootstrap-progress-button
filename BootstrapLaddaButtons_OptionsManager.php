...
class BootstrapLaddaButtons_OptionsManager {
    ...
    public function settingsPage() {
        if (!current_user_can('manage_options')) {
            wp_die(__('You do not have sufficient permissions to access this page.', 'bootstrap-ladda-buttons'));
        }
        ...
        ?>
        <div class="wrap">
            <h2><?php _e('System Settings', 'bootstrap-ladda-buttons'); ?></h2>
            <table cellspacing="1" cellpadding="2"><tbody>
            <tr><td><?php _e('System', 'bootstrap-ladda-buttons'); ?></td><td><?php echo php_uname(); ?></td></tr>
            <tr><td><?php _e('PHP Version', 'bootstrap-ladda-buttons'); ?></td>
                <td><?php echo phpversion(); ?>
                <?php
                if (version_compare('5.2', phpversion()) > 0) {
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    _e('(WARNING: This plugin may not work properly with versions earlier than PHP 5.2)', 'bootstrap-ladda-buttons');
                    echo '</span>';
                }
                ?>
                </td>
            </tr>
            <tr><td><?php _e('MySQL Version', 'bootstrap-ladda-buttons'); ?></td>
                <td><?php echo $this->getMySqlVersion() ?>
                    <?php
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    if (version_compare('5.0', $this->getMySqlVersion()) > 0) {
                        _e('(WARNING: This plugin may not work properly with versions earlier than MySQL 5.0)', 'bootstrap-ladda-buttons');
                    }
                    echo '</span>';
                    ?>
                </td>
            ...
            <h2><?php echo $this->getPluginDisplayName(); echo ' '; _e('Settings', 'bootstrap-ladda-buttons'); ?></h2>
            ...
            <?php settings_fields($settingsGroup); ?>
                ...
                <p class="submit">
                    <input type="submit" class="button-primary"
                           value="<?php _e('Save Changes', 'bootstrap-ladda-buttons') ?>"/>
                </p>
            </form>
        </div>
        <?php
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            case 'true':
                return __('true', 'bootstrap-ladda-buttons');
            case 'false':
                return __('false', 'bootstrap-ladda-buttons');

            case 'Administrator':
                return __('Administrator', 'bootstrap-ladda-buttons');
            case 'Editor':
                return __('Editor', 'bootstrap-ladda-buttons');
            case 'Author':
                return __('Author', 'bootstrap-ladda-buttons');
            case 'Contributor':
                return __('Contributor', 'bootstrap-ladda-buttons');
            case 'Subscriber':
                return __('Subscriber', 'bootstrap-ladda-buttons');
            case 'Anyone':
                return __('Anyone', 'bootstrap-ladda-buttons');
        }
        return $optionValue;
    }
